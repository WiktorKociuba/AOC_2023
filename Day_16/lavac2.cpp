...
int main(){
    ...
    for(int z = 0; z < 110; z++){
        ...
        czy_odwiedzone[z][0] = 1;
        laser(1,make_pair(z,0));
        int wynik_lok = 0;
        for(int i = 0; i < 110; i++){
            for(int j = 0; j < 110; j++){
                if(czy_odwiedzone[i][j] == 1)
    ...
    for(int z = 0; z < 110; z++){
        ...
        czy_odwiedzone[z][109] = 1;
        laser(3,make_pair(z,109));
        int wynik_lok = 0;
        for(int i = 0; i < 110; i++){
            for(int j = 0; j < 110; j++){
                if(czy_odwiedzone[i][j] == 1)
    ...
    for(int z = 0; z < 110; z++){
        ...
        czy_odwiedzone[0][z] = 1;
        laser(2,make_pair(0,z));
        int wynik_lok = 0;
        for(int i = 0; i < 110; i++){
            for(int j = 0; j < 110; j++){
                if(czy_odwiedzone[i][j] == 1)
    ...
    for(int z = 0; z < 109; z++){
        ...
        czy_odwiedzone[109][z] = 1;
        laser(4,make_pair(109,z));
        int wynik_lok = 0;
        for(int i = 0; i < 110; i++){
            for(int j = 0; j < 110; j++){
                if(czy_odwiedzone[i][j] == 1)
